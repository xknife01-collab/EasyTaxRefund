export const simulator = {
  ...
  "waiting_banner_title": "💡 තේරීමක් බලාපොරොත්තුවෙන් (සිමියුලේෂනය තාවකාලಿಕව නවතා ඇත)",
  "waiting_banner_desc": "කරුණාකර දුරකථන තිරයේ ඇති [විකල්ප දෙකෙන්] එකක් ක්ලිಕ್ කරන්න! සිමියුලේෂනය ස්වයංක්‍රීයව නැවත ආරම්භ වේ.",
};
