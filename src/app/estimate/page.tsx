...
import { Step0IntroView } from "@/components/estimate/steps/Step0IntroView";
import { Step05PreconsentView } from "@/components/estimate/steps/Step05PreconsentView";
import { Step1PreparationView } from "@/components/estimate/steps/Step1PreparationView";
import { Step2AlienCardView } from "@/components/estimate/steps/Step2AlienCardView";
import { Step3ContactInfoView } from "@/components/estimate/steps/Step3ContactInfoView";
          ...
          <div className="relative">
            {step === 0 && (
              <Step0IntroView
                ...
                setPreFilterData={setPreFilterData}
            ...
            {step === 0.5 && (
              <Step05PreconsentView
                onPrev={() => { setStep(0); saveProgress(0); }}
                onNext={() => { setStep(1); saveProgress(1); }}
              />
            )}

            {step === 1 && (
              <Step1PreparationView
                isNtsMaintenance={isNtsMaintenance}
            ...
            {step === 2 && (
              <Step2AlienCardView
                onPrev={() => { setStep(1); saveProgress(1); }}
                formData={formData}
                setFormData={setFormData}
                prefetchNameOptimization={prefetchNameOptimization}
            ...
            {step === 3 && (
              <Step3ContactInfoView
                onPrev={() => { setStep(2); saveProgress(2); }}
                formData={formData}
                setFormData={setFormData}
                isOptimizing={isOptimizing}
                setIsNameHelpOpen={setIsNameHelpOpen}
                nameSuggestions={nameSuggestions}
                isSignUpAgreed={isSignUpAgreed}
                setIsSignUpAgreed={setIsSignUpAgreed}
            ...
            {step === 4 && (
              <Step4AuthMethodView
                ...
                setHanaGuideMode={setHanaGuideMode}
                setIsHanaGuideOpen={setIsHanaGuideOpen}
                setIsKakaoGuideOpen={setIsKakaoGuideOpen}
                setIsGuideOpen={setIsGuideOpen}
                handleInitiateAuth={handleInitiateAuth}
                loading={loading}
                onPrevFromRoot={() => { setStep(3); saveProgress(3); }}
              />
            )}
