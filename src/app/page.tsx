...
const COUNTRY_REVIEW_VIDEOS: Record<string, { name: string; amount: string; flag: string; poster: string; videoUrl: string }> = {
  ...
  en: {
    name: "Maria",
    amount: "+2,780,000 Won",
    flag: "🇵🇭",
    poster: "/reviews/maria.png",
    videoUrl: "https://ilvxvohksgwdiyvpkwag.supabase.co/storage/v1/object/public/review-videos/philippines_refund_review.mp4"
  },
  ne: {
    name: "Sita",
                ...
                <div key={i} className="flex gap-8">
                  {[
                    { 
                      ...
                      text: t("맨 처음에는 한국어를 몰라서 인증앱을 어떻게 깔아야 하나 걱정부터 앞섰어요. 그런데 KTRS의 자세한 안내를 하나하나 따라하다 보니 인증에 성공했구요. 결과는 대박! 제가 받을 수 있는 금액이 310만원이나 되더라구요. 신청 후 2달 뒤에 어김없이 국세청에서 입금되었습니다. 여러분 두려워 마세요!") 
                    },
                    { 
                    ...
                    { 
                      name: "Oleg", country: t("카자흐스탄"), flag: "🇰🇿", amount: "2,150,000", image: "/reviews/kazakhstan.png",
                      text: t("처음에는 혹시 수수료를 미리 내야 하는 사기 서비스일까 봐 많이 망설였습니다. 그런데 KTRS는 신청할 때 돈을 1원도 받지 않는 100% 후불제라 안심하고 진행했어요. 한국어가 서툴러도 간편인증 가이드만 보고 따라 하니 5분 만에 끝났고, 진짜로 국세청에서 제 통장으로 215만원이 바로 입금되었습니다! 돈이 들어온 걸 직접 확인하고 나서 수수료를 정산하는 완벽한 후불 시스템이라 주변 카자흐스탄 동료들에게도 무조건 추천하고 있습니다.") 
                    },
                    { 
                      name: "Fatima", country: t("파키스탄"), flag: "🇵🇰", amount: "2,650,000", image: "/reviews/pakistan.png",
                      text: t("외국인 근로자가 한국에서 세금을 돌려받을 수 있다는 것도 몰랐고, 통신사 본인인증이 항상 막혀서 포기하려 했습니다. 하지만 이곳의 단계별 화면 가이드 덕분에 단번에 인증에 성공했어요! 무엇보다 선결제나 수수료 요구 없이 100% 후불제로 진행된다는 점이 정말 안심되었습니다. 신청 후 국세청에서 265만원이 통장으로 입금되었을 때 너무 기뻤습니다. 수수료는 입금 확인 후 정산하면 되니 사기 걱정 전혀 없습니다!") 
                    },
                    { 
                      name: "Sopheak", country: t("캄보디아"), flag: "🇰🇭", amount: "2,450,000", image: "/reviews/cambodia.png",
                      text: t("공장에서 일하는 캄보디아 친구가 추천해줘서 환급금을 조회해 봤는데 245만원이나 돌려받을 수 있다고 해서 깜짝 놀랐습니다. 처음엔 미리 돈을 내야 하는 줄 알고 불안했는데, 환급금이 내 통장에 안전하게 들어올 때까지 비용이 전혀 들지 않는 100% 후불 정산제라는 것을 알고 바로 신청했습니다. 세무사님이 안전하게 전담 처리해주셔서 제 통장에 245만원이 꽂혔습니다. 최고입니다!") 
                    },
                    { 
                    ...
                    { 
                      name: "Dinesh", country: t("스리랑카"), flag: "🇱🇰", amount: "3,200,000", image: "/reviews/srilanka.png",
                      text: t("한국에서 일한 지 4년이 넘었는데 이런 제도가 있는 줄 이번에 처음 알았습니다. 다른 곳은 선입금을 요구해서 의심스러웠는데, 여기는 100% 후불제라 국세청에서 320만원 입금 알림이 스마트폰에 뜬 후에 수수료를 정산했습니다. 과정 내내 카카오톡과 AI 비서가 친절하게 다국어로 안내해줘서 막힘없이 완료할 수 있었습니다. 스리랑카 동료 여러분, 선수수료 0원이니 고민하지 말고 지금 꼭 조회해 보세요!") 
                    },
                    { 
                      name: "Asma", country: t("방글라데시"), flag: "🇧🇩", amount: "1,980,000", image: "/reviews/bangladesh.png",
                      text: t("한국 세법이 너무 복잡해서 제가 낸 세금을 되찾을 생각은 꿈도 못 꿨습니다. KTRS는 국세청 전산과 공식 연동되어 안전하고, 무엇보다 '국세청 환급금 통장 입금 확인 후 수수료 정산'이라는 확실한 후불 원칙이 있어서 믿음이 갔습니다. 스마트폰으로 1분 만에 조회하고 신청했는데 정확히 198만원이 계좌로 입금 완료되었습니다. 정당한 나의 권리를 찾아준 KTRS 팀에 진심으로 감사드립니다.") 
                    },
                    { 
                    ...
                    { 
                      ...
                      text: t("처음엔 내 정보를 넣는 게 무서웠어요. 하지만 암호화 기술과 무저장 원칙을 보고 신뢰가 생겼습니다. 인증 성공하고 조회해보니 142만원이나 있었네요! 실제로 돈이 입금되는 걸 확인하니 정말 감격스러웠습니다. KTRS 팀 감사합니다.") 
                    },
                    { 
