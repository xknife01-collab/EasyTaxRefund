...
remaining = ["kk", "km", "mn", "my", "ne_new_stable", "si", "ur_new", "uz", "bn"]
chat_translations = {
    "kk": "Агентпен тікелей сөйлесу",
    "km": "ជជែកផ្ទាល់ជាមួយភ្នាក់ងារ",
    "mn": "Ажилтантай шууд чатлах",
    "my": "ကိုယ်စားလှယ်နှင့် တိုက်ရိုက် စကားပြောရန်",
    "ne_new_stable": "एजेन्टसँग सिधै कुराकानी गर्नुहोस्",
    "si": "නියෝජිතයා සමඟ සෘජුව කතාබස් කරන්න",
    "ur_new": "ایجنٹ کے ساتھ براہ راست چیٹ کریں",
    "uz": "Agent bilan bevosita suhbatlashish",
    "bn": "এজেন্টের সাথে সরাসরি চ্যাট করুন"
}
faq_translations = {
    "kk": "Жиі қойылатын сұрақтар (FAQ)",
    "km": "សំណួរដែលសួរញឹកញាប់ (FAQ)",
    "mn": "Түгээмэл асуултууд (FAQ)",
    "my": "အမေးများသော မေးခွန်းများ (FAQ)",
    "ne_new_stable": "प्रायः सोधिने प्रश्नहरू (FAQ)",
    "si": "නිතර අසන ප්‍රශ්න (FAQ)",
    "ur_new": "اکثر پوچھے گئے سوالات (FAQ)",
    "uz": "Ko'p beriladigan savollar (FAQ)",
    "bn": "সচরাচর জিজ্ঞাস্য (FAQ)"
}

for lang in remaining:
    translations[lang] = list(translations["en"])
    translations[lang][-2] = chat_translations[lang]
    translations[lang][-1] = faq_translations[lang]
